...
Document Type: New governance document
Sections Added (8 total):
...
# Control de Gastos — Constitución del Proyecto

Una guía de arquitectura, seguridad, pruebas y governance para el sistema de registro y control de gastos de usuarios.
...
1. Este proyecto reconstruye el sistema "Gastos" de las Sesiones 6-8, cuya
   ...
   sección "Contrato de compatibilidad" de `spec.md` y ninguna tarea de
   `tasks.md` puede renombrar, reordenar o eliminar un símbolo de esa lista.
